...
#check if INSTANA_AGENT_KEY, INSTANA_AGENT_HOST, INSTANA_AGENT_PORT exists, if not cancel the installation process.
...
# Set the host, port, key and protocol in file - /opt/instana/agent/etc/instana/com.instana.agent.main.sender.Backend.cfg
